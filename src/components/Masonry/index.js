...
export const Masonry = ({ children, className, setStyleMasonry, columnsCountBreakPoints }) => {
	...
	const renderColumns = getColumns().map((item, i) => (
	...
	//
	return (
		<div className={className} style={{ display: 'grid', gridTemplateColumns: `repeat(${columnsCount},1fr)`, columnGap: '10px', rowGap: ' 15px' }}>
			{renderColumns}
		</div>
	);
};
